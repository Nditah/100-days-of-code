      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start bg-veryDarkBlue text-white p-10 md:pt-20 md:pb-32">
        ...
        <div className="flex-1 text-center md:text-left md:flex pt-3 ">
          <div className="md:pr-10">
            ...
            <ul className="py-2">
              <li>
                <a className="text-xs text-gray-500 hover:text-cyan" href="#shortening">
                  Link Shortening
                </a>{" "}
              </li>
              <li>
                <a className="text-xs text-gray-500 hover:text-cyan" href="#branded">
                  Branded Links
                </a>{" "}
              </li>
              <li>
                <a className="text-xs text-gray-500 hover:text-cyan" href="#analytics">
                  Analytics
                </a>
              </li>
            </ul>
