  ...
  for (let i = 0; i < 50; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url:
            "https://res.cloudinary.com/dqqhf85vd/image/upload/v1609242328/YelpCamp/emq9m3z8js2mzxlo8nuh.jpg",
          filename: "YelpCamp/emq9m3z8js2mzxlo8nuh",
        },
        {
          url:
            "https://res.cloudinary.com/dqqhf85vd/image/upload/v1609242329/YelpCamp/ldk6jcxzbmgvkehwnsuy.jpg",
          filename: "YelpCamp/ldk6jcxzbmgvkehwnsuy",
        },
      ],
      // Hardcoded coords
      geometry: { type: "Point", coordinates: [-117.3235478, 33.2487821] },
    });
    await camp.save();
  }
};
