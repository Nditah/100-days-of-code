    ...
    <div className="container mx-auto px-4 md:py-24 py-10 gridHeader">
      <div className="textDiv flex-1 flex flex-col justify-center">
        <div className="flex flex-col items-center sm:items-start justify-center">
          <h1 className="text-3xl md:text-6xl font-semibold text-veryDarkViolet text-center sm:text-left leading-tight mt-4">
            More than just shorter links
          </h1>
          <p style={{maxWidth: '80%'}} className="text-md text-gray-700 text-center sm:text-left my-3">
